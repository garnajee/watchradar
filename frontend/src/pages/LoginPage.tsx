...
export function LoginPage() {
  ...
  if (user) return null;
  const configurationWarning = getConfigurationWarning(configuration, configurationError);
    ...
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-night px-5 py-12 text-ink">
      ...
      <div className="relative w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-white">WatchRadar</h1>
          <p className="mt-2 text-sm text-muted">Retrouvez votre cercle Jellyfin, en direct.</p>
        </div>
        ...
        >
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-muted">Utilisez vos identifiants Jellyfin habituels.</p>
          </div>
          ...
          {configurationWarning && (
            ...
            >
              ...
              <div>
                <p className="font-semibold">Configuration Jellyfin incomplète</p>
        ...
        <p className="mt-5 text-center text-xs text-muted">
          Votre mot de passe est transmis à Jellyfin et n'est jamais enregistré.
        </p>
      </div>
    </main>
  );
